(function () {
  ...
  QUnit.test('isEqual', function (assert) {
    ...
    assert.ok(!_.isEqual(new String('Curly'), {
      toString: function () {
        return 'Curly';
      }
    ...
    assert.ok(!_.isEqual(new Number(63), {
      valueOf: function () {
        return 63;
      }
    ...
    assert.ok(!_.isEqual({x: 1, y: void 0}, {
      x: 1,
      z: 2
    ...
    // Chaining.
    assert.ok(!_.isEqual(_({x: 1, y: void 0}).chain(), _({
      x: 1,
      z: 2
