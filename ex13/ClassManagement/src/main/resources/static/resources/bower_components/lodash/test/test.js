;(function () {
  ...
  var alwaysNaN = function () {
      return NaN;
    },
    alwaysNull = function () {
      return null;
    },
    alwaysUndefined = function () {
      return undefined;
    };
  ...
  (function () {
    QUnit.test('should create a function that returns `value`', function (assert) {
      ...
      var object = {'a': 1},
        ...
        expected = lodashStable.map(values, function () {
          return true;
        });
    ...
    QUnit.test('should work with falsey values', function (assert) {
      ...
      var expected = lodashStable.map(falsey, function () {
        return true;
      });
    ...
    QUnit.test('should compare typed arrays', function (assert) {
      ...
      var pairs = lodashStable.map(typedArrays, function (type, index) {
        var otherType = typedArrays[(index + 1) % typedArrays.length],
          CtorA = root[type] || function (n) {
            this.n = n;
          },
          CtorB = root[otherType] || function (n) {
            this.n = n;
          },
    ...
    if (methodName == 'omitBy') {
      prop = function (object, props) {
        ...
        return function (value) {
          return _.some(props, function (key) {
